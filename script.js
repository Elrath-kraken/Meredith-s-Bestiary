...
$(document).ready(function() {
    ...
    $("#layer").change(function() {
        ...
        if (val == "0") {
            ...
            $("#region").html("<option value='0.0'>Select a region</option> <option value='1.1'>First Region</option><option value='1.2'>Second Region</option>");
        } else if (val == "2") {
            $("#region").html("<option value='0.0'>Select a region</option> <option value='2.1'>First Region</option><option value='2.2'>Second Region</option>");
    ...
    $("#region").change(function() {
        ...
        if (val == "0.0") {
            ...
            $("#monster").html("<option value='0.0.0'>Select a monster</option> <option value='2.2.1'>Armored Ape</option><option value='2.2.2'>Dismemberment Troll</option> <option value='2.2.3'>Primordial Ape</option>");
